...
const useCases = [
  {
    ...
    desc: "Автоматизация рутины, аналитика конкурентов и быстрый поиск по всем проектам",
    hashtag: "#стартап"
  },
  {
    icon: Lightbulb,
    title: "Продуктовики",
    desc: "Пайплайны из интервью в задачи, перенос данных и структурирование фидбека",
    hashtag: "#продакт"
  },
  {
    icon: Target,
    title: "Исследователи",
    desc: "Парсинг статей, саммаризация сложных текстов и связывание фактов в базу",
    hashtag: "#ресерч"
  }
]
