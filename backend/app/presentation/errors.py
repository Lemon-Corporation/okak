...
ERROR_STATUS_BY_CODE = {
    ...
    "invalid_verification_code": status.HTTP_400_BAD_REQUEST,
    "verification_code_expired": status.HTTP_400_BAD_REQUEST,
    "invalid_reset_code": status.HTTP_400_BAD_REQUEST,
    "reset_code_expired": status.HTTP_400_BAD_REQUEST,
    "email_disabled": status.HTTP_500_INTERNAL_SERVER_ERROR,
